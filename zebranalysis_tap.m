...
for mm = 1:size(fast_locs,1)
    ...
    %delay
    tmp_swim_bouts(mm,13) = (tmp_swim_bouts(mm,1)-idx_tap(mm))*frame_length_calc_ms; %if there is an error --> error in tap/escape ID
end
...
savePath = strcat(PathName,'AST_TAP_data.mat');
